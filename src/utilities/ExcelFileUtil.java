...
public class ExcelFileUtil
{
	...
	{ 
		...
		for(int i=1;i<=rowcount;i++) //acess all data  give equal to then it wll read all
		{
			...
			//access shhet dtaa
			xl.setCellData("Empdata_1", i, 3, "Pass", "C:/EClipse_Shraddha/OutputFormat.xlsx"); //get data from excel and write pass/fail/blocked in 4 col
			...
			//xl.setCelladata("Empdata_1", i, 3, "Blocked", "C:/EClipse_Shraddha/OutputFormat.xlsx"); //get data from excel and write pass/fail/blocked in 4 col
